...
const CustomAppointment = ({ appointment }) => {
  return (
    <div className='grid lg:grid-cols-7 lg:grid-rows-1 md:grid-cols-8 sm:grid-cols-8 grid-cols-8 py-4 px-4 lg:py-2 gap-4 lg:gap-5 border-t-2 border-gray-200 w-full'>
      ...
      <div className='flex items-center gap-1 text-gray-600 font-medium lg:col-span-1 md:col-span-4 col-span-4'>
        <FaRegCalendarAlt />
      ...
      <div className='flex items-center gap-1 col-span-4 md:col-span-4 lg:col-span-1'>
        <svg className="svg-icon fill-current w-5 text-green-600"
      ...
      <div className='font-medium self-center col-span-4 lg:col-span-1 md:col-span-4 sm:col-span-4'>
        <div className='bg-blue-200 text-gray-600 w-max px-3 py-2 rounded-lg text-xs font-bold tracking-tight'>
          {appointment.injury}
        </div>
      </div>

      <button className='cursor-pointer text-gray-300 hover:text-gray-400 self-center lg:justify-self-center
